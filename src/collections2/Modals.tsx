                ...
                <div className="relative p-4 w-full max-w-2xl max-h-full">
                    <div className="relative rounded-lg shadow bg-gray-700">
                        ...
                        <div className="flex items-center p-4 md:p-5 border-t rounded-b border-gray-600">
                            ...
                            <button onClick={close}
                                className="varbtn w-32 border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700">
                                    Cancel
                            </button>
                        </div>
                    </div>
